- dashboard: state_cases__policy_response
  ...
  - title: Daily Growth Rate
    ...
    filters:
      jhu_sample_county_level_final.country_region: US
      jhu_sample_county_level_final.is_max_date: 'Yes'
  ...
  - title: Current Summary
    ...
    fields: [jhu_sample_county_level_final.county, jhu_sample_county_level_final.confirmed_cases_per_icu_beds,
      jhu_sample_county_level_final.confirmed_cases_per_licensed_beds, jhu_sample_county_level_final.confirmed_running_total,
      jhu_sample_county_level_final.deaths_running_total, jhu_sample_county_level_final.confirmed_running_total_per_million]
    filters:
      jhu_sample_county_level_final.country_region: US
    ...
    series_labels:
      ...
      prior_days_cases_covid.seven_day_average_change_rate_deaths_running_total: Death
        Growth
      jhu_sample_county_level_final.confirmed_running_total_per_million: Cases / Mil
      ...
      jhu_sample_county_level_final.confirmed_cases_per_licensed_beds: Cases / Licensed
        Bed
  ...
  - title: Next Week Extrapolation (7 Days Out)
    ...
    series_labels:
      ...
      jhu_sample_county_level_final.confirmed_new: New Cases
      jhu_sample_county_level_final.confirmed_cases_per_icu_beds: Cases / ICU Bed
      jhu_sample_county_level_final.confirmed_cases_per_licensed_beds: Confirmed /
        Licensed
    series_cell_visualizations:
      jhu_sample_county_level_final.confirmed_running_total:
        is_active: false
  ...
  - title: State Mandates
    ...
    fields: [jhu_sample_county_level_final.province_state, policies_by_state.non_essential_business_closures,
    ...
    filters:
      jhu_sample_county_level_final.country_region: US
    sorts: [jhu_sample_county_level_final.province_state]
    limit: 500
    column_limit: 50
    show_view_names: false
    custom_color_enabled: true
  ...
  - title: Confirmed Cases by County
    ...
    explore: jhu_sample_county_level_final
    type: looker_column
    fields: [jhu_sample_county_level_final.measurement_date, jhu_sample_county_level_final.county_top_x,
    ...
    sorts: [jhu_sample_county_level_final.measurement_date, jhu_sample_county_level_final.county_top_x]
    limit: 500
    column_limit: 50
    x_axis_gridlines: false
    y_axis_gridlines: true
